...
public class UOBTransaction implements Comparable<UOBTransaction> {
	...
	protected UOBTransaction(UOBTransactionManager _sUOBTransactionManager,
		 ...
		 */
		UOBValueInColumnManager lUOBValueInColumnManager = mUOBTransactionManager.getmMainManager().getmUOBValueInColumnManager();		
	...
	public final double getmAmountUSD() {
		return getmAmount() * mUOBTransactionManager
				.getmMainManager().getmForexManager().getValue(mUOBAccount.getmCurrency());
	}
