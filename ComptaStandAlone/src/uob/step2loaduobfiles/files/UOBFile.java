...
public class UOBFile  implements Comparable<UOBFile> {
	...
	protected UOBFile(UOBFileManager _sUOBFileManager, LitUnFichierEnLignes _sReadFile) {
	...
	protected final void computeAscendingOrDescending() {
		if (mListUOBTransaction.size() <= 1) {
			...
			/////////////////////////////////////////////////////////////////
			if (mNameFile.equals("2017_02_USD_AccountStatement.csv")) {
				System.out.println("NameFile= " + mNameFile
						+ "\n LedgerPreviousFile= " + mLedgerBalancePreviousFile
						+ "\n mUOBFilePrevious= " + mUOBFilePrevious);
				AMNumberTools.isZero(0);
			}
			/////////////////////////////////////////////////////////////////
	...
	public final void errorInFile(String _sErroMSg) {
		mUOBFileManager.getmUOBAccountLoader().getmComManager().displayFatalError(this, 
